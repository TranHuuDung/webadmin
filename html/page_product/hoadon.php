...
<?php 
	...
	function LayDanhSachSanPham($conn){
		// global $conn;
		// var_dump($conn);
	...
	function LayDanhSachHoaDon($conn){
		// global $conn;
	...
	function HienThiDanhMucLoaiSanPham($conn){
		// global $conn;
